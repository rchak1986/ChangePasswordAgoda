...
public class TestPasswordSimilarity {
    ...
    public void TC17TestLessThan80PSimilarity() {
		...
		Reporter.log("Sample Old Password setup:" + "ABCDefgh@#$1234567");
    ...
    public void TC19TestMoreThan80PSimilarity() {
		...
		cp.setOldPassword("ABCDefgh@#$1234567");
		Reporter.log("Sample Old Password setup:" + "ABCDefgh@#$1234567");
		Assert.assertFalse(cp.changePassword("ABCDefgh@#$1234567", "ABCDefgh@#$1234560"),"Password should NOT have been changed successfully - more than similarity factor");
		Reporter.log("Test Data used: " + "ABCDefgh@#$1234560");
	}
